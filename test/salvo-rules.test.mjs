...
function combatState() {
  return Object.freeze({
    ...
    weapons: Object.freeze({
      a: Object.freeze({ key: "a", name: "A", mount: "port", fireAP: 1, reloadRounds: 1, reloadRemaining: 0, lastFiredRound: null }),
      b: Object.freeze({ key: "b", name: "B", mount: "port", fireAP: 1, reloadRounds: 1, reloadRemaining: 0, lastFiredRound: null }),
      c: Object.freeze({ key: "c", name: "C", mount: "starboard", fireAP: 1, reloadRounds: 1, reloadRemaining: 0, lastFiredRound: null })
    }),
    log: Object.freeze([])
  });
}
...
test("coordinated salvo combines same-facing weapons into one firing event", () => {
  ...
  assert.equal(next.weapons.a.reloadRemaining, 1);
  assert.equal(next.weapons.b.reloadRemaining, 1);
