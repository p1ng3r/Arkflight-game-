...
export function stationActionRulesText(action) {
  ...
  const rules = {
    ...
    "captain-drive-the-crew": "Spend 1 Morale. Gain 1 AP for this turn and gain 2 Strain. At ship level 15+ gain only 1 Strain; at level 20 gain no Strain. Once per round.",
    "engineer-overcharge-arkengine": "Spend 1 AP and gain 2 Strain. Gain one additional full Helm block this turn: movement equal to Combat Speed and facing steps equal to Maneuverability. Once per round.",
...
export function stationResourceIdentity() {
  return Object.freeze({
    ...
    strain: "Strain: pressure from pushing the ship beyond safe operation; high Strain risks ship-area consequences.",
