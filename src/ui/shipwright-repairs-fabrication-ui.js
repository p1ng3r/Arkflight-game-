...
function renderPanel(app, root) {
  ...
  panel.innerHTML = `
    ...
    <div class="arkflight-rf-grid">
      ...
      <section class="arkflight-rf-card"><h3><i class="fa-solid fa-hammer"></i> Ship Repairs</h3><div class="arkflight-rf-repair-note"><strong>Repair workbench connected.</strong><br>Repair workbench connected. Repair Hull Integrity and Lifeveil as resources, or improve the persistent Hull, Drive, and Weapons Ship Conditions through the repair controls.</div></section>
