...
const CORE_ACTIONS = [
  ...
  action({
    ...
    description: "Gain one additional full Helm block this turn: movement equal to Combat Speed and facing allowance equal to Maneuverability × 60°. Gain 1 Strain. Once per round.",
  ...
  action({
    ...
    station: "navigator",
    name: "Extra Maneuver",
    description: "Spend 1 AP to gain additional facing allowance equal to effective Maneuverability × 60°. This exceptional maneuver allowance permits an in-place pivot.",
    summary: "Gain another Maneuverability × 60° of facing allowance; may pivot.",
    ap: 1,
  ...
  action({
    ...
    station: "navigator",
    name: "Hard Turn",
    description: "Gain additional facing allowance equal to (Maneuverability + Station Bonus) × 60° this turn, and you may pivot in place. Gain 1 Strain.",
    summary: "+(Maneuverability + Station Bonus) × 60° facing; may pivot; +1 Strain.",
    ap: 1,
    category: COMBAT_ACTION_CATEGORIES.MANEUVER,
...
const ADDITIONAL_ACTIONS = [
  ...
  action({
    ...
    description: "Once per battle, gain 120° of extraordinary facing allowance this turn. This does not consume the ship's normal Maneuverability allowance.",
    summary: "Once/battle: gain 120° extraordinary facing allowance this turn.",
    ap: 0,
    category: COMBAT_ACTION_CATEGORIES.MANEUVER,
