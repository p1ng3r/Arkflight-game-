...
const CORE_ACTIONS = [
  ...
  action({
    ...
    station: "captain",
    name: "Rally Crew",
    description: "Restore 20% Morale × Station Bonus, or improve a degraded Morale area by one step. At ship level 15+, improving the Morale area also restores 20% Morale × Station Bonus.",
