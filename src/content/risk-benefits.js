...
export const RISK_BENEFITS = Object.freeze([
  ...
  B("pressure-drop-1","Bleed Strain",2,["strain"],"Reduce 1 ship-wide Strain.","Reduce 2 ship-wide Strain."),
  B("pressure-drop-2","Stabilize the Crisis",5,["strain"],"Reduce 2 ship-wide Strain.","Reduce 3 ship-wide Strain."),
  B("pressure-drop-3","Master the Strain",8,["strain"],"Reduce 3 ship-wide Strain.","Reduce 4 Strain and suppress one related Hazard this round."),
  B("pressure-guard-1","Brace the Ship",2,["strain","guard"],"Prevent the next 1 ship-wide Strain gained this round.","Prevent the next 2 Strain."),
  B("pressure-guard-2","Hold the Line",5,["strain","guard"],"Prevent up to 2 ship-wide Strain this round.","Prevent up to 3 Strain this round."),
  B("pressure-guard-3","Unbreakable",8,["strain","guard"],"Prevent all Strain from the next authored consequence.","Prevent all authored consequence Strain for the rest of the round."),
  ...
  B("hazard-suppress-2","Contain the Threat",5,["hazard","control"],"Suppress one Hazard for the rest of the round.","Suppress it and reduce 1 Strain."),
  ...
  B("ship-ability-refresh","Reset the Mechanism",8,["ship-ability","refresh"],"Refresh one eligible expended one-use ship/component ability.","Refresh it and reduce 1 Strain."),
  ...
  B("arkengine-vent","Vent the Core",2,["arkengine","strain"],"Reduce ship-wide Strain by 1.","Reduce ship-wide Strain by 2."),
  B("arkengine-overdrive","Controlled Overdrive",5,["arkengine","risk"],"Next Engineer or Navigator action gains +2.","It gains +3 and prevents the next 1 Strain generated by that action.","crew"),
  B("arkengine-master","Master the Arkengine",8,["arkengine","signature"],"Refresh an Engineer Signature or reduce ship-wide Strain by 2.","Do both and gain +1 Momentum."),
  B("lifeveil-steady","Steady the Lifeveil",2,["lifeveil","strain"],"Reduce ship-wide Strain by 1.","Reduce ship-wide Strain by 2."),
  ...
  B("hull-brace","Brace the Hull",2,["hull","guard"],"Prevent 1 Strain from the next authored consequence.","Prevent 2 Strain from that consequence."),
  ...
  B("mixed-softener","Make It Count",2,["round-outcome","strain"],"If the round ends Mixed Success, reduce its authored Strain increase by 1.","If Mixed, remove that Strain increase entirely."),
  B("failure-softener","Refuse the Worst",5,["round-outcome","guard"],"If the round ends Failure, reduce one authored consequence in severity.","If Failure, treat its Momentum loss as 0 and reduce 1 Strain."),
  B("disaster-buffer","Against Disaster",8,["round-outcome","guard"],"If the round ends Disaster, suppress one Hazard it would create.","If Disaster, also reduce its Strain increase by 1."),
  ...
  B("condition-suppress","Work Around the Damage",5,["condition","ship"],"Ignore one active Ship Condition's listed penalty for the rest of the round.","Ignore that listed penalty for the rest of the encounter."),
  B("condition-stabilize","Keep It Functional",8,["condition","ship"],"Prevent one Hull, Drive, or Weapons Ship Condition from worsening this round.","If eligible, also improve that Ship Condition by one step for the encounter."),
  ...
  B("pressure-transfer","Take the Load",5,["strain","teamwork"],"Reduce 1 Strain from the current consequence by shifting the load through the crew.","Reduce up to 2 Strain from that consequence."),
  ...
  B("pressure-threshold-raise","Reinforce the Limit",5,["strain","threshold"],"Treat the ship's Strain capacity as 1 higher for this round.","Treat it as 2 higher for this round."),
  B("pressure-threshold-raise-big","Beyond Safe Limits",8,["strain","threshold"],"Treat the ship's Strain capacity as 2 higher for the encounter.","Treat it as 3 higher for the encounter, then reduce Strain by 1."),
