...
export const BASE_MASTERY = Object.freeze({
  ...
  engineer: Object.freeze([
    ...
    M({ id: "engineer-keep-her-breathing", name: "Keep Her Breathing", triggerLabel: "When a Ship Condition would worsen to its worst stage", description: "Delay that worsening through the end of the next station resolution before the new Ship Condition takes hold.", timing: "condition-worsen", target: "ship-condition", effect: Object.freeze({ kind: "delay-condition-worsen", stations: 1 }) }),
