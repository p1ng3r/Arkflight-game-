...
export const BASE_MASTERY = Object.freeze({
  ...
  engineer: Object.freeze([
    M({ id: "engineer-redline-the-arkengine", name: "Redline the Arkengine", triggerLabel: "Before Engineer or Navigator rolls", description: "Before an Engineer or Navigator check, improve its final degree of success by one step, up to Critical Success. After the check, the ship gains 1 ship-wide Strain.", timing: "before-engineer-or-navigator-check", target: "engineer-or-navigator", effect: Object.freeze({ kind: "redline", degreeLift: 1, strain: 1 }) }),
    M({ id: "engineer-keep-her-breathing", name: "Keep Her Breathing", triggerLabel: "Before Strain can worsen a Ship Condition", description: "Choose Hull, Drive, or Weapons. If this Strain consequence would push that system from its second-worst condition into its final condition, prevent that worsening.", timing: "before-strain", target: "condition-guard", effect: Object.freeze({ kind: "guard-final-condition" }) }),
    M({ id: "engineer-crosswire-the-systems", name: "Crosswire the Systems", triggerLabel: "Before Strain can worsen a Ship Condition", description: "Choose an eligible Ship Condition. If this source of Strain causes degradation, that condition takes the degradation instead of the normal d8 target.", timing: "before-strain", target: "condition-redirect", effect: Object.freeze({ kind: "redirect-condition-degradation" }) })
  ]),
  ...
  veilwarden: Object.freeze([
    M({ id: "veilwarden-stand-between", name: "Stand Between", triggerLabel: "Before Strain can worsen a Ship Condition", description: "If this source of Strain causes degradation, redirect that degradation to Lifeveil instead of the normal d8 target.", timing: "before-strain", target: "condition-redirect", effect: Object.freeze({ kind: "redirect-condition-degradation", destination: "lifeveil" }) }),
...
export const ADVANCED_MASTERY = Object.freeze({
  ...
  engineer: Object.freeze([
    M({ id: "engineer-run-her-hot", name: "Run Her Hot", tier: "specialist", triggerLabel: "Before Engineer or Navigator rolls", description: "Choose Engineer or Navigator. That station gains +4 to its next check; after the check the ship gains 1 ship-wide Strain.", timing: "before-engineer-or-navigator-check", target: "engineer-or-navigator", effect: Object.freeze({ kind: "hot-run", checkBonus: 4, strain: 1,  }) }),
