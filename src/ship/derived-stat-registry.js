...
export const DERIVED_STAT_REGISTRY = Object.freeze({
  ...
  lifeveilCapacity: stat("lifeveilCapacity", { label: "Legacy Lifeveil Capacity", category: "lifeveil", presentation: "hidden", min: 0 }),
  ...
  supplyCapacity: stat("supplyCapacity", { label: "Legacy Supply Capacity", category: "logistics", presentation: "hidden", min: 0 }),
  moraleCapacity: stat("moraleCapacity", { label: "Legacy Morale Capacity", category: "crew", presentation: "hidden", min: 0 }),
