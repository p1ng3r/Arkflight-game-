...
export function createRefitJob({
  ...
  return Object.freeze({
    ...
    socketIndices: Object.freeze([...new Set((socketIndices ?? []).map((value) => nonNegativeInteger(value)))]),
    ...
    reservation: Object.freeze({
      partsSpent: nonNegativeInteger(reservation?.partsSpent),
      componentHeld: Boolean(reservation?.componentHeld)
    }),
    result,
    createdAt,
    startedAt,
