const DEFAULT_POOLS = Object.freeze({
  ...
  battlewatch: Object.freeze(["crossbow", "longbow", "shortbow"]),
  veilwarden: Object.freeze(["staff", "mace", "morningstar"])
});

const FACTION_POOLS = Object.freeze({
  "grelkin cartel": Object.freeze({ captain:["battle-axe","falchion","longsword"], engineer:["warhammer","maul","pick"], navigator:["shortsword","spear","hatchet"], battlewatch:["crossbow","shortbow","longbow"], veilwarden:["staff","mace","flail"] }),
  "brotherhood of the cosmic flame": Object.freeze({ captain:["longsword","spear","rapier"], engineer:["warhammer","light-hammer","mace"], navigator:["rapier","spear","shortsword"], battlewatch:["crossbow","longbow","spear"], veilwarden:["staff","mace","spear"] }),
  freespacers: Object.freeze({ captain:["rapier","saber","shortsword"], engineer:["warhammer","light-hammer","club"], navigator:["rapier","shortsword","spear"], battlewatch:["longbow","crossbow","shortbow"], veilwarden:["staff","mace","spear"] }),
  freebooters: Object.freeze({ captain:["saber","rapier","longsword"], engineer:["warhammer","light-hammer","maul"], navigator:["rapier","shortsword","spear"], battlewatch:["crossbow","longbow","shortbow"], veilwarden:["staff","mace","morningstar"] }),
  "underwake syndicates": Object.freeze({ captain:["rapier","shortsword","dagger"], engineer:["light-hammer","warhammer","club"], navigator:["rapier","dagger","shortsword"], battlewatch:["crossbow","shortbow","dagger"], veilwarden:["staff","mace","dagger"] }),
  "council of the void": Object.freeze({ captain:["spear","staff","rapier"], engineer:["warhammer","staff","mace"], navigator:["spear","staff","rapier"], battlewatch:["crossbow","longbow","spear"], veilwarden:["staff","mace","spear"] })
});
